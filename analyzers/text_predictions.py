...
"""
Módulo para análise de textos e prognósticos de futebol.
"""
...
class TextPredictionsAnalyzer:
    ...
    def analyze_general_predictions(self) -> Dict[str, Any]:
        ...
        if not general:
            return {"error": "Prognósticos gerais não disponíveis"}
        
        # Extrair dados relevantes
        over_1_5_percentage = general.get("over_1_5_percentage", 0)
        over_2_5_percentage = general.get("over_2_5_percentage", 0)
        btts_percentage = general.get("btts_percentage", 0)
        
        goals_per_game = general.get("goals_per_game", 0)
        cards_per_game = general.get("cards_per_game", 0)
        corners_per_game = general.get("corners_per_game", 0)
        
        # Comparar com médias da liga
        over_1_5_league_avg = general.get("over_1_5_league_avg", 0)
        over_2_5_league_avg = general.get("over_2_5_league_avg", 0)
        btts_league_avg = general.get("btts_league_avg", 0)
        
        goals_per_game_league_avg = general.get("goals_per_game_league_avg", 0)
        cards_per_game_league_avg = general.get("cards_per_game_league_avg", 0)
        corners_per_game_league_avg = general.get("corners_per_game_league_avg", 0)
    ...
    def analyze_detailed_predictions(self) -> Dict[str, Any]:
        ...
        if goals_detailed:
            ...
            # Calcular médias
            over_0_5_avg = over_0_5.get("average", 0)
            over_1_5_avg = over_1_5.get("average", 0)
            over_2_5_avg = over_2_5.get("average", 0)
            over_3_5_avg = over_3_5.get("average", 0)
            over_4_5_avg = over_4_5.get("average", 0)
            btts_avg = btts.get("average", 0)
        ...
        if corners:
            # Extrair dados relevantes
            over_6_corners = corners.get("over_6_corners_percentage", 0)
            over_7_corners = corners.get("over_7_corners_percentage", 0)
            over_8_corners = corners.get("over_8_corners_percentage", 0)
            over_9_corners = corners.get("over_9_corners_percentage", 0)
            over_10_corners = corners.get("over_10_corners_percentage", 0)
        ...
        if cards:
            # Extrair dados relevantes
            over_2_5_cards = cards.get("over_2_5_cards_percentage", 0)
            over_3_5_cards = cards.get("over_3_5_cards_percentage", 0)
            over_4_5_cards = cards.get("over_4_5_cards_percentage", 0)
        ...
        if halftime_fulltime:
            # Extrair dados relevantes
            home_win_1h = halftime_fulltime.get("home_win_1h", 0)
            home_win_2h = halftime_fulltime.get("home_win_2h", 0)
            home_draw_1h = halftime_fulltime.get("home_draw_1h", 0)
            home_draw_2h = halftime_fulltime.get("home_draw_2h", 0)
            home_loss_1h = halftime_fulltime.get("home_loss_1h", 0)
            home_loss_2h = halftime_fulltime.get("home_loss_2h", 0)
            
            away_win_1h = halftime_fulltime.get("away_win_1h", 0)
            away_win_2h = halftime_fulltime.get("away_win_2h", 0)
            away_draw_1h = halftime_fulltime.get("away_draw_1h", 0)
            away_draw_2h = halftime_fulltime.get("away_draw_2h", 0)
            away_loss_1h = halftime_fulltime.get("away_loss_1h", 0)
            away_loss_2h = halftime_fulltime.get("away_loss_2h", 0)
        ...
        if first_goal:
            # Extrair dados relevantes
            home_first_goal = first_goal.get("home_first_goal_percentage", 0)
            away_first_goal = first_goal.get("away_first_goal_percentage", 0)
